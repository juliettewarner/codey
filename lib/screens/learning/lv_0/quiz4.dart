...
class Lv0Quiz4Screen extends StatefulWidget {
  final String userId;
  final String userName;

  const Lv0Quiz4Screen({
    super.key,
  ...
  @override
  State<Lv0Quiz4Screen> createState() => _Lv0Quiz4ScreenState();
}

class _Lv0Quiz4ScreenState extends State<Lv0Quiz4Screen> {
  ...
  final String question = 'عندما ينجز الحاسوب العمليات المطلوبة منه فإنه يُعطينا:';
  final List<String> options = const ['الرسوم', 'الصور', 'المخرجات'];
  ...
  void _goNext() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (_) => Lv0Quiz5Screen(userId: widget.userId, userName: widget.userName),
      ),
    );
  }
