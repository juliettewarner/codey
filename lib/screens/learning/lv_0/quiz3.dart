...
class Lv0Quiz3Screen extends StatefulWidget {
  final String userId;
  final String userName;

  const Lv0Quiz3Screen({
    super.key,
  ...
  @override
  State<Lv0Quiz3Screen> createState() => _Lv0Quiz3ScreenState();
}

class _Lv0Quiz3ScreenState extends State<Lv0Quiz3Screen> {
  ...
  final String question = 'يقوم الحاسوب بداخله مجموعة من العمليات تُسمّى:';
  final List<String> options = const ['نسخ', 'معالجة', 'إضافة'];
  ...
  Future<void> _onChoose(int idx) async {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (_) => Lv0Quiz4Screen(userId: widget.userId, userName: widget.userName),
      ),
    );
  }
