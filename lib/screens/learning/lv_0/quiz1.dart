...
class Lv0Quiz1Screen extends StatefulWidget {
  final String userId;
  final String userName;

  const Lv0Quiz1Screen({
    super.key,
  ...
  @override
  State<Lv0Quiz1Screen> createState() => _Lv0Quiz1ScreenState();
}

class _Lv0Quiz1ScreenState extends State<Lv0Quiz1Screen> {
  ...
  // ✅ سؤال 1
  final String question = 'تُسمّى المعلومات والصور التي تدخل إلى الحاسوب:';
  final List<String> options = const ['المدخلات', 'المخرجات', 'تعديل'];
