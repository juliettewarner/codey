...
class Lv0Intro1Screen extends StatelessWidget {
  final String userId;
  final String userName;

  final int stepIndex; // يبدأ من 1
  final int totalSteps;

  const Lv0Intro1Screen({
    super.key,
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            ...
            // ✅ رموز بالخلفية (هي الخلفية الوحيدة)
            Positioned.fill(
              child: CustomPaint(
            ...
            SafeArea(
              child: Column(
                children: [
                  ...
                  // ✅ (تم حذف الـ Progress Bar بالكامل)

                  const SizedBox(height: topSpacing),

                  // ✅ Stack: الكارد + زر ثابت بدون مساحة بيضاء
                  Expanded(
                    child: Stack(
                      children: [
                              ...
                              Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      'الحاسوب: جهازٌ ينفّذ الأوامر التي نطلبها منه.',
                                    ...
                                    const SizedBox(height: 8),
                                    Text(
                                      'كلُّ ما يدخل إلى الحاسوب يُسمّى مدخلات، وكلُّ ما يخرج منه يُسمّى مخرجات، وبينهما يقوم الحاسوب بعملية تُسمّى المعالجة.',
                                      textAlign: TextAlign.center,
                                      style: GoogleFonts.cairo(
                                        fontSize: 15.5,
                                    ...
                                    _MiniCard(
                                      title: '✅ أمثلة سريعة',
                                      items: const [
                                        'المدخلات: صورة، نص، صوت.',
                                        'المخرجات: صورة بعد التعديل، نص مطبوع، صوت.',
                                        'المعالجة: تعديل صورة، حلّ مسألة، تنقية صوت.',
                                      ],
                                    ),
                        ...
                        // ✅ زر التالي تحت الكارد مباشرة وبدون لوح أبيض
                        Positioned(
                          left: 16,
                          right: 16,
                          bottom: 16,
