...
class Lv0Quiz2Screen extends StatefulWidget {
  final String userId;
  final String userName;

  const Lv0Quiz2Screen({
    super.key,
  ...
  @override
  State<Lv0Quiz2Screen> createState() => _Lv0Quiz2ScreenState();
}

class _Lv0Quiz2ScreenState extends State<Lv0Quiz2Screen> {
  ...
  final String question = 'هي مجموعة الأوامر التي يكتبها الإنسان إلى الحاسوب لإجراء عمل معيّن:';
  final List<String> options = const ['رسالة', 'البرنامج', 'المعدات'];
  ...
  Future<void> _onChoose(int idx) async {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (_) => Lv0Quiz3Screen(userId: widget.userId, userName: widget.userName),
      ),
    );
  }
