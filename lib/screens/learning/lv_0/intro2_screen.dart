...
class Lv0Intro2Screen extends StatelessWidget {
  final String userId;
                              ...
                              Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      'البرمجة: هي إعطاء أوامر للحاسوب.',
                                    ...
                                    const SizedBox(height: 8),
                                    Text(
                                      'نكتب أوامر لكي يفهم الحاسوب ما الذي يجب عليه فعله.\nمجموعة الأوامر تُسمّى برنامجًا.',
                                      textAlign: TextAlign.center,
                                      style: GoogleFonts.cairo(
                                        fontSize: 15.5,
                                    ...
                                    _MiniCard(
                                      title: '⭐ فكرة مهمة',
                                      items: const [
                                        'البرنامج: هو مجموعة من الأوامر.',
                                        'نكتب هذه الأوامر باستخدام كلمات ورموز خاصّة.',
                                        'وهذا ما نُسمّيه "الكود".',
                                      ],
                                    ),
