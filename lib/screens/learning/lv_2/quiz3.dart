...
class Lv2Quiz3Screen extends StatefulWidget {
  final String userId;
  final String userName;

  const Lv2Quiz3Screen({
    super.key,
  ...
  @override
  State<Lv2Quiz3Screen> createState() => _Lv2Quiz3ScreenState();
}

class _Lv2Quiz3ScreenState extends State<Lv2Quiz3Screen> {
  ...
  final String question = 'ماذا سيطبع البرنامج؟';
  final String code =
      'a = 100\nb = 200\n'
      'if a > b:\n  print(a)\n'
      'if b > a:\n  print(b)';

  final List<String> options = const ['100', '200', 'لن يطبع شيئًا'];
  ...
  Future<void> _onChoose(int idx) async {
    ...
    if (idx != correctIndex) {
      ...
      await _showResultDialog(
        isCorrect: false,
        message: 'الإجابة خاطئة 😅\nأي شرط يتحقق؟ جرّبي تقارنين a و b.',
      );
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (_) => Lv2Quiz4Screen(userId: widget.userId, userName: widget.userName),
      ),
    );
  }
