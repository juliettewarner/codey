...
class Lv2Quiz1Screen extends StatefulWidget {
  final String userId;
  final String userName;

  const Lv2Quiz1Screen({
    super.key,
  ...
  @override
  State<Lv2Quiz1Screen> createState() => _Lv2Quiz1ScreenState();
}

class _Lv2Quiz1ScreenState extends State<Lv2Quiz1Screen> {
  ...
  final String question = 'ما ناتج هذا الكود؟';
  final String code = 'name = "Ali"\nclassName = "B"\nprint(name, className)';
  final List<String> options = const ['Ali B', 'Ali', 'B Ali'];
  ...
  Future<void> _onChoose(int idx) async {
    ...
    if (idx != correctIndex) {
      ...
      await _showResultDialog(isCorrect: false, message: 'الإجابة خاطئة، فكّر بناتج print 🙂');
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (_) => Lv2Quiz2Screen(userId: widget.userId, userName: widget.userName),
      ),
    );
  }
