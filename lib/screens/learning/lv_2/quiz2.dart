...
class Lv2Quiz2Screen extends StatefulWidget {
  final String userId;
  final String userName;

  const Lv2Quiz2Screen({
    super.key,
  ...
  @override
  State<Lv2Quiz2Screen> createState() => _Lv2Quiz2ScreenState();
}

class _Lv2Quiz2ScreenState extends State<Lv2Quiz2Screen> {
  ...
  final int stepIndex = 2;
  final int totalSteps = 5;
  double get _progress => (stepIndex / totalSteps).clamp(0.0, 1.0);

  final String question = 'ما الخطأ في هذا الكود؟';
  final String code = 'a = Ahmad\nb = Ali\nprint(a, b)';

  final List<String> options = const [
    'لم تُوضَع النصوص بين علامتَي اقتباس " "',
    'يجب كتابة Print بحرف كبير',
    'لا يجوز استخدام حرف a كمتغيّر',
  ];
  ...
  Future<void> _onChoose(int idx) async {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (_) => Lv2Quiz3Screen(userId: widget.userId, userName: widget.userName),
      ),
    );
  }
