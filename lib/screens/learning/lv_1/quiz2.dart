...
class _Quiz2ScreenState extends State<Quiz2Screen> {
  ...
  final String question = 'عند كتابة شرط في البرمجة نستخدم الكلمة print';
  final List<String> options = const ['صح', 'خطأ'];
  ...
  Future<void> _onChoose(int idx) async {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (_) => Quiz3Screen(userId: widget.userId, userName: widget.userName),
      ),
    );
  }
